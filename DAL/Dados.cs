...
namespace DAL
{
    public class Dados
    {
        private string conexaoBanco = "Data Source=(local/SQLEXPRESS);Initial Catalog=Clientes;Integrated Security=True";
        ...
        private SqlCommand AdicionarParametros(SqlCommand command, Clientes model, bool ehUpdateOuDelete)
        {
            ...
            command.Parameters.AddWithValue("@DtNascimento", model.DtNascimento);
